...
string fileLocation = "/media/gurumurt/Data/PhD/CODD-pro/data/tpch/sf1";


void executeTpchQueries::executeQ1(BaseCompute *adapter) {

    vector<vector<int>> lineitemData = adapter->readLineItem(fileLocation + "/lineitem.tbl");
...
void executeTpchQueries::executeQ3(BaseCompute *adapter) {
    vector<vector<int>> lineitemData = adapter->readLineItem(fileLocation + "/lineitem.tbl");
    vector<vector<int>> ordersData = adapter->readOrders(fileLocation + "/orders.tbl");
    vector<vector<int>> customerData = adapter->readCustomer(fileLocation + "/customer.tbl");
...
void executeTpchQueries::executeQ4(BaseCompute *adapter){
    ...
    vector<vector<int>> orderData = adapter->readOrders(fileLocation + "/orders.tbl");
